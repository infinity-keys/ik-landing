...
const DummyThumbnail = ({ name }: { name: string }) => {
  return (
    <div className="puzzle-thumb relative flex w-full max-w-[10rem] items-center rounded-lg bg-blue-800 py-3 px-3 text-center opacity-60 shadow grayscale lg:px-4">
