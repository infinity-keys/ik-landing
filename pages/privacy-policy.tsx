    ...
    <Wrapper>
      ...
      <div className="max-w-2xl my-20">
        ...
        <p className="mt-6">
          ...
          Policy to describe to you our practices regarding the Personal Data
          (as defined below) we collect, use, and share in connection with the
          Infinity Keys website provided on or in connection with our services.
        ...
        <p className="mt-6">Types of Data We Collect.</p>
        <p className="mt-6">
          “Personal Data” means data that allows someone to identify you
          individually, including, for example, email address, as well as any
          other non-public information about you that is associated with or
        ...
        <p className="mt-6">Information You Provide Us.</p>
        <p className="mt-6">
          When you use our Service or contact us we may collect Personal Data
          from you, such as email address, first and last name, and other
          information you provide. We also collect your blockchain address,
          which may become associated with Personal Data when you use our
          Service.
        </p>
        <p className="mt-6">
        ...
        <p className="mt-6">
          ...
          the message. We may also collect Personal Data at other points in our
          Service where you voluntarily provide it or where we state that
          Personal Data is being collected.
        </p>
        <p className="mt-6">Information Collected via Technology.</p>
        <p className="mt-6">
          ...
          Information Collected by Our Servers. To provide our Service and make
          it more useful to you, we (or a third party service provider) collect
          information from you, including, but not limited to, your browser
          type, operating system, Internet Protocol (“IP”) address, mobile
          device ID, blockchain address, wallet type, and date/time stamps.
        </p>
        <p className="mt-6">Log Files.</p>
        <p className="mt-6">
          As is true of most websites and applications, we gather certain
        ...
        <p className="mt-6">
          Like many online services, we use cookies to collect information. We
          ...
          delete them) to analyze how users interact with our Service, make
          improvements to our product quality, and provide users with a more
          personalized experience.
        </p>
        <p className="mt-6">How We Respond to Do Not Track Signals.</p>
        <p className="mt-6">
        ...
        <p className="mt-6">
          ...
          companies may set their own cookies or similar tools when you visit
          our Service. This includes third-party analytics services (“Analytics
          Services”) that we engage to help analyze how users use the Service.
          The information generated by the Cookies or other technologies about
          your use of our Service (the “Analytics Information”) is transmitted
          to the Analytics Services. The Analytics Services use Analytics
          Information to compile reports on user activity, which we may receive
          on an individual or aggregate basis. We use the information we get
        ...
        <p className="mt-6">
          ...
          that offer their products and/or services for use in conjunction with
          our Service or whose products and/or services may be linked from our
        ...
        <p className="mt-6">Public Information Observed from Blockchains.</p>
        <p className="mt-6">
        ...
        <p className="mt-6">Use of Your Personal Data.</p>
        <p className="mt-6">
        ...
        <ul>
          ...
          <li>
            ...
            by analyzing how you and other users
          </li>
          <li>find and interact with the Service;</li>
          <li>
            provide customer support and respond to your requests and inquiries;
          </li>
          <li>
            detect, prevent, and address fraud and/or other harmful or unlawful
            activity;
          </li>
        ...
        <p className="mt-6">
          We may create Anonymous Data records from Personal Data.
        </p>
        <p className="mt-6">
          We use this Anonymous Data to analyze request and usage patterns so
          that we may improve our Services and enhance Service navigation. We
        ...
        <p className="mt-6">Disclosure of Your Personal Data.</p>
        <p className="mt-6">
          We disclose your Personal Data as described below and as described
          elsewhere in this Privacy Policy.
        </p>
        <p className="mt-6">Third Party Service Providers.</p>
        <p className="mt-6">
          We may share your Personal Data with third party service providers to:
          provide technical infrastructure services; conduct quality assurance
          testing; analyze how our Service is used; prevent, detect, and respond
          to unauthorized activities; provide technical and customer support;
          and/or to provide other support to us and to the Service.
        </p>
        <p className="mt-6">Affiliates.</p>
        <p className="mt-6">
          We may share some or all of your Personal Data with any subsidiaries,
          joint ventures, or other companies under our common control
          (“Affiliates”), in which case we will require our Affiliates to honor
          this Privacy Policy.
        </p>
        <p className="mt-6">Corporate Restructuring.</p>
        <p className="mt-6">
          ...
          possess the Personal Data collected by us and will assume the rights
          and obligations regarding your Personal Data as described in this
          Privacy Policy.
        </p>
        <p className="mt-6">Legal Rights.</p>
        <p className="mt-6">
          Regardless of any choices you make regarding your Personal Data (as
          described below), Infinity Keys may disclose Personal Data if it
          ...
          laws or to respond to subpoenas, warrants, or other legal process
          served on Infinity Keys; (c) to protect or defend the rights or
          property of Infinity Keys or users of the Service; and/or (d) to
          investigate or assist in preventing any violation or potential
          violation of the law or this Privacy Policy.
        </p>
        <p className="mt-6">Other Disclosures.</p>
        <p className="mt-6">
          We may also disclose your Personal Data: to fulfill the purpose for
          which you provide it; for any other purpose disclosed by us when you
          provide it; or with your consent.
        </p>
        <p className="mt-6">Third-Party Websites. </p>
        <p className="mt-6">
          ...
          third-party websites or their content, or to any collection of your
          Personal Data after you click on links to such third-party websites.
        ...
        <p className="mt-6">Third-Party Wallets.</p>
        <p className="mt-6">
          To use our Service, you must use a third-party wallet which allows you
          to engage in transactions on public blockchains. Your interactions
        ...
        <p className="mt-6">
          ...
          have certain rights under the respective European and UK General Data
          Protection Regulations (“GDPR”). These include the right to (i)
          ...
          data with your consent, you have the right to withdraw your consent at
          any time.
        </p>
        <p className="mt-6">
        ...
        <p className="mt-6">
          ...
          applicable data protection or privacy laws, please contact us by using
          the Infinity Keys Discord channel at the address provided in Section
          13 below, specify your request, and reference the applicable law. We
          may ask you to verify your identity, or ask for more information about
          your request. We will consider and act upon any above request in
          accordance with applicable law. We will not discriminate against you
        ...
        <p className="mt-6">
          ...
          information stored on the blockchain may include purchases, sales, and
        ...
        <p className="mt-6">
          ...
          fulfill the purposes outlined in this Privacy Policy. We may continue
          to retain your Personal Data even after you deactivate your account
          and/or cease to use the Service if such retention is reasonably
          necessary to comply with our legal obligations, to resolve disputes,
          prevent fraud and abuse, enforce other agreements, and/or protect our
          legitimate interests. Where your Personal Data is no longer required
          for these purposes, we will delete it.
        </p>
        <p className="mt-6">Data Protection.</p>
        <p className="mt-6">
          We care about the security of your information and use physical,
          administrative, and technological safeguards to preserve the integrity
          and security of information collected through our Service. However, no
          security system is impenetrable and we cannot guarantee the security
          of our systems. In the event that any information under our custody
          and control is compromised as a result of a breach of security, we
          will take steps to investigate and remediate the situation and, in
        ...
        <p className="mt-6">
          ...
          contact us by using the “Submit a request” link at the address
          indicated in Section 13 below.
        </p>
        <p className="mt-6">Users Outside of the United States.</p>
        <p className="mt-6">
          If you are a non-U.S. user of the Service, by visiting the Service and
          providing us with data, you acknowledge and agree that your Personal
          Data may be processed for the purposes identified in the Privacy
          Policy. In addition, your Personal Data may be processed in the
          country in which it was collected and in other countries, including
          the United States, where laws regarding processing of Personal Data
          may be less stringent than the laws in your country. By providing your
          Personal Data, you consent to such transfer.
        </p>
        <p className="mt-6">Changes to This Privacy Policy.</p>
        <p className="mt-6">
          This Privacy Policy may be updated from time to time for any reason.
          The date the Privacy Policy was last revised is identified at the
          beginning of this Privacy Policy. You are responsible for periodically
          visiting our Service and this Privacy Policy to check for any changes.
        </p>
        <p className="mt-6">
          Questions; Contacting Infinity Keys; Reporting Violations.{" "}
        </p>
        <p className="mt-6">
          ...
          to report any security violations to us, please contact us by using
          the Infinity Keys community chat{" "}
          <a
