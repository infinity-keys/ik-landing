...
const CookieConsentBanner = () => {
  ...
  return (
    <CookieConsent
      ...
      disableStyles
      containerClasses="backdrop-blur-md	border-t border-indigo-500 fixed bottom-0 z-50 w-full text-gray-100 p-4 bg-blue/60 md:flex justify-between items-center"
